...
- Capital-efficiency / dead-money exit + sunk-cost guard (forward base case vs hurdle; never moves the grade) — portfolio-analysis.md §The holding verdict, §Portfolio roll-up and construction; portfolio-workflow.md §Step 6b, §Step 6e, §Step 7; configuration.md §Investor Profile
...
- Fund path (reduced compute: expense drag, exposure tilt, fund valuation; constituent look-through off-plan → N-PORT/dropped; future issuer-holdings adapter) — portfolio-analysis.md §Asset eligibility
