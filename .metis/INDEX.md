...
- Local analysis suite configuration (daemon, roster, SearXNG, Schwab, **Trade Opportunities discovery breadth / candidate research budget**; gates local jobs only) — configuration.md §Local Analysis Suite Configuration
