...
Run `/metis-plan-task` for the first vertical slice (manual report, stubbed main agent, end to end). The data-source layer is settled (FMP/FRED/BLS direct REST) and can follow the slice.
