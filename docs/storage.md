...
- **Trade Opportunities** — per run, the 3×3 matrix of opportunities (each with its directional thesis, leading operating metric, catalyst, horizon, risk tier, conviction, narrative-vs-reality read, bear case, **key falsifiers**, entry consideration, any risk / forensic flags, and carry-forward status).
