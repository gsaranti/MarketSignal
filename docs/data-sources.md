...
Two **maintenance populations** additionally ride a subset of the same rows outside the discovery funnel, scaling with the live matrix, watchlist, and episode populations rather than the discovery budget (tagged inline below).
