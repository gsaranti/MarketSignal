...
The deliberate exception is a **fetch range's upper bound**: those stay on the UTC date, since a range ending one day late simply serves no row for the untraded day, and each such site is annotated as left alone on purpose.
