...
Every accepted row persists `admitted_under` = `portfolio-v29` (Codex I20 plus Review 2 N1; later revision, assumption-unit, fund-classification, commodity-context, and prompt-contract slices moved the shared prompt stamp).
