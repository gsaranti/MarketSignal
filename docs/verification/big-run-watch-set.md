...
The observation-admission-stamp slice (Codex I20) moved the checkpoint format stamp to `checkpoint-v3`; the required period span moves it again to `checkpoint-v4`.
