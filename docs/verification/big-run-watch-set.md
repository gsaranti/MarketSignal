...
Every accepted row persists `admitted_under` = `portfolio-v34` (Codex I20 plus Review 2 N1; later revision, assumption-unit, fund-classification, commodity-context, prompt-contract, distillation-channel, Finding-2 prompt-clarity, Finding-3 action-call prompt-clarity, and Finding-4 Fix-B slices moved the shared prompt stamp).
