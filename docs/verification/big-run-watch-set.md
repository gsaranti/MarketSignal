...
Every accepted row persists `admitted_under` = `portfolio-v28` (Codex I20 plus Review 2 N1; later revision, assumption-unit, fund-classification, and commodity-context slices moved the shared prompt stamp).
