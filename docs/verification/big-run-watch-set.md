...
Every accepted row persists `admitted_under` = `portfolio-v30` (Codex I20 plus Review 2 N1; later revision, assumption-unit, fund-classification, commodity-context, prompt-contract, and distillation-channel slices moved the shared prompt stamp).
