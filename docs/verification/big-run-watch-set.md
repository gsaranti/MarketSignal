...
The observation-admission-stamp slice (Codex I20) landed after them, moving the checkpoint format stamp alone (`checkpoint-v3`).
...
Every accepted row persists `admitted_under` = `portfolio-v23` (Codex I20).
