...
**The forward-assumption leg below is designed, not built** — it lands with the research-loop slice (with research stubbed, nothing reaches this seam), and as-built the overlay finalization above is the step's whole work, computed at the engine seam.
